module FFIGenerate
  class Generator
    ...
    def generate_java
      writer = Writer.new "    ", " * ", "/**", " */"
      writer.puts "// Generated by ffi_generator. Please do not change this file by hand.", "import java.util.*;", "import com.sun.jna.*;", "import java.lang.annotation.*;", "import java.lang.reflect.Method;", "", "public interface #{@module_name} extends Library {"
      writer.indent do
